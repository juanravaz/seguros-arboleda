    ...
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section>
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-5">
                                ...
                                <h2>
                                    With Priva, no more hassles &amp; no more worries
                                </h2>
                            ...
                            <div class="col-lg-6 offset-md-1 d-none d-lg-block d-xl-block text-center">
                                <img class="relative img-fluid" src="images/misc/2.jpg" alt="" />
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <div class="image-container col-md-6 pull-left" data-bgimage="url(images/background/11.jpg) center"></div>

                <div class="container">
                    <div class="row">
                        <div class="inner-padding">
                            <div class="col-md-6 offset-md-7" data-animation="fadeInRight" data-delay="200">
                                <span class="p-title bg-color-secondary">Priva Insurance</span><br>
                                <h2>
            ...
            <section class="text-light text-center">
                <a href="{{ route('carcreate') }}" class="btn btn-lg btn-primary">
                    Cree su seguro de Coche Ahora
                </a>
            </section>
