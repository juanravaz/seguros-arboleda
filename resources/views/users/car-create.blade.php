...
<body>
                ...
                <div class="container">
						<div class="row">
							...
							<form name="form" id="form" class="form-border" method="POST" >
                                @csrf
								<div class="field-set">
                                    <select name="brand" id="brand" class="form-control dynamic"  data-dependent="model">
                                ...
                                <div class="field-set">
                                    <select name="model" id="model" class="form-control dynamic"  data-dependent="brand">

                                    </select>
								</div>

                                <div class="field-set mb-4">
                                    <label for="gasofa">Tipo de combustible del Vehículo: </label>
                                    <select name="gasofa" id="gasofa" class="form-control">
                                ...
                                <div class="field-set mb-4">
                                    <label for="Km">Kilometraje del Vehículo: </label>
                                    <input type="number" name="km" id="km" class="form-control" min="0"/>
                                </div>

                                <div class="field-set mb-4">
                                    <label for="dt_entry_service">Fecha de puesta en circulación: </label>
                                    <input class="form-control" type="date" name="dt_entry_service" id="dt_entry_service" min="1900-12-31"/>
                                </div>

                                <div class="mb-4">
									<input type="button" id="enviar" value="Calcular el Seguro de tu coche" class="btn btn-custom" />
								</div>
    ...
    ================================================== -->
        ...
        <script src="js/autovisual.js"></script>
