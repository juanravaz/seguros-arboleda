						...
						<div class="row">
							...
							<form name="form" id="form" class="form-border" method="POST" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="date" class="form-control" id="exampleFormControlInput1" placeholder="Fecha de nacimiento">
                                </div>
                                <div class="mb-4">
                                    <input type="button" id="enviar" value="Calcular el Seguro de vida" class="btn btn-custom" />
                                </div>
                            </form>
                            <div class="carPrice">
                            ...
                            <form style="visibility: hidden;" action="{{ url('/paypal/pay') }}" method="GET" name="form2" id="form2">
                                ...
                                <input type="hidden" name="DNI" id="formDNI" />
                                <input type="hidden" name="Name" id="formName" />
                                <input type="hidden" name="Birth" id="formBirth" />
